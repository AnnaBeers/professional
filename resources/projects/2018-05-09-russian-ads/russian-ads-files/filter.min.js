  ...
  F.show = function(result, type){
   ...
   $("#primary-image").children('img').attr('src', 'https://github.com/AndrewBeers/anderff-site/raw/master/resources/projects/2018-05-09-russian-ads/data/' + $(this).children(".caption").children('.detail').children('.image_filepath').text());
    ...
    for(i = 0; i < ad_values_length; i++) {
      $("#primary-details").children().children('#' + ad_values[i]).text($(this).children(".caption").children('.detail').children('.' + ad_values[i]).text());
    }

    $("#primary-details").children().children('#download').children().attr("href", ('https://github.com/AndrewBeers/anderff-site/raw/master/resources/projects/2018-05-09-russian-ads/data/' + $(this).children(".caption").children('.detail').children('.pdf_filepath').text()));

    history.replaceState('', 'Russian Ad Explorer', 'http://127.0.0.1:4000/resources/projects/2018-05-09-russian-ads/?ad_id=' + $(this).children(".caption").children('.detail').children('.ad_id').text())
    });
