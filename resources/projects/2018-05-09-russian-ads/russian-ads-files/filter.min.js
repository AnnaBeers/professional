  ...
  F.show = function(result, type){
   ...
   $("#primary-image").children('img').attr('src', 'https://github.com/AndrewBeers/anderff-site/raw/master/resources/projects/2018-05-09-russian-ads/data/' + $(this).children(".caption").children('.detail').children('.image_filepath').text());
    ...
    for(i = 0; i < ad_values_length; i++) {
      $('#' + ad_values[i]).text($(this).children(".caption").children('.detail').children('.' + ad_values[i]).text());
    }

    $("#download").children().attr("href", ('https://github.com/AndrewBeers/anderff-site/raw/master/resources/projects/2018-05-09-russian-ads/data/' + $(this).children(".caption").children('.detail').children('.pdf_filepath').text()));
